...
module.exports = (robot) ->
  ...
  robot.respond /paint it/, (msg) -> 

    paints = [ 
      "http://www.azquotes.com/picture-quotes/quote-happy-painting-and-god-bless-my-friend-bob-ross-111-7-0782.jpg",
      "http://images.fineartamerica.com/images-medium-large-5/sun-after-rain-shirwan-ahmed.jpg",  
      "http://dailyurbanista.com/wp-content/uploads/2015/08/bob-ross-meme-350x244.jpg" 
      
      ]
  

    paintsIndex = Math.min(Math.max(Math.round(Math.random() * paints.length), 0), paints.length)

    msg.reply paints[paintsIndex]
